...
graph TB
    ...
    subgraph "Domain Verification APIs"
    ...
    subgraph "Gadget Actions"
        G1[trackReferral]
        G2[trackCustomerJourney]
        G3[getBusinessAnalytics]
        G4[getBusinessDashboard]
    end
    
    subgraph "Middleware"
        M1[requireAuth]
        M2[requireBusinessAuth]
        M3[requireAdmin]
        M4[preventCrossShopDataAccess]
    end
