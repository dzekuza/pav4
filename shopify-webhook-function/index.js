...
// Configuration
const MAIN_APP_WEBHOOK_URL =
  process.env.MAIN_APP_WEBHOOK_URL ||
  "https://ipick.io/.netlify/functions/track-event";
const MAIN_APP_API_KEY =
  process.env.MAIN_APP_API_KEY || "16272754ed68cbdcb55e8f579703d92e";
...
exports.shopifyWebhookHandler = async (message, context) => {
  try {
    ...
    const { topic, shop_domain, event_id, triggered_at, payload } = data;
