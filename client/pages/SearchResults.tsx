    ...
    try {
      ...
      if (data.mainProduct && data.suggestions) {
        ...
        const mainProduct: ProductData = {
          ...
          store: new URL(data.mainProduct.url || searchUrl).hostname.replace(
            /^www\./,
            "",
          ),
        };
        ...
        trackProductSearch({
          ...
          sessionId:
            sessionStorage.getItem("pricehunt_session_id") || undefined,
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <div
              className="w-full max-w-md mx-auto bg-gray-200 rounded-full h-2"
              role="progressbar"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">
                Price Comparisons (
                {comparisons.filter((c) => (c.price || 0) > 0).length})
              </h2>
                        ...
                        {comparison.url && (
                          <div className="flex flex-col gap-2">
                            ...
                            <Button
                              ...
                              title={
                                favoriteStates.get(
                                  `${comparison.store}-${comparison.title}`,
                                )?.isFavorited
                                  ? "Remove from favorites"
                                  : "Add to favorites"
                              }
        ...
        {comparisons.length > 0 &&
          comparisons.filter((c) => (c.price || 0) > 0).length === 0 && (
            <Card>
              <CardContent className="p-8 text-center">
