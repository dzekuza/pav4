...
export const TrackingScriptGenerator: React.FC<
  TrackingScriptGeneratorProps
> = ({ businessId, affiliateId, businessName }) => {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate the tracking script for {businessName} to monitor affiliate
            performance
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="debug-mode">
              Enable debug mode (shows tracking logs in console)
            </Label>
          </div>
          ...
          {selectedTab === "script" && (
            <div className="space-y-4">
              ...
              <Alert>
                <AlertDescription>
                  <strong>Important:</strong> Add this script to your website's
                  &lt;head&gt; section. The script will automatically track page
                  views, product clicks, add-to-cart events, and purchases.
                </AlertDescription>
              </Alert>
            </div>
          )}
          ...
          {selectedTab === "instructions" && (
            <div className="space-y-4">
              ...
              <Alert>
                <AlertDescription>
                  <strong>Note:</strong> After installation, it may take a few
                  minutes for tracking data to appear in your dashboard.
                </AlertDescription>
              </Alert>
            </div>
          )}
          ...
          {selectedTab === "testing" && (
            <div className="space-y-4">
              ...
              <Alert>
                <AlertDescription>
                  <strong>Debug Mode:</strong> When enabled, the tracking script
                  will log all events to the browser console, making it easier
                  to verify that tracking is working correctly.
                </AlertDescription>
              </Alert>
            </div>
          )}
