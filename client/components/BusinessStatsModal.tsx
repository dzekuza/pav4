...
export function BusinessStatsModal({ business, onClose }: BusinessStatsModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-medium">Projected Fee</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{formatCurrency(projectedFee)}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-medium">Revenue per Visit</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {business.totalVisits > 0 ? formatCurrency(business.totalRevenue / business.totalVisits) : '$0.00'}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant={conversionRate > 5 ? "default" : conversionRate > 2 ? "secondary" : "destructive"}>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant={business.totalRevenue > 10000 ? "default" : business.totalRevenue > 5000 ? "secondary" : "destructive"}>
                    {business.totalRevenue > 10000 ? "High" : business.totalRevenue > 5000 ? "Medium" : "Low"}
                  </Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Traffic Quality:</span>
                  <Badge variant={business.totalVisits > 1000 ? "default" : business.totalVisits > 500 ? "secondary" : "destructive"}>
                    {business.totalVisits > 1000 ? "High" : business.totalVisits > 500 ? "Medium" : "Low"}
                  </Badge>
                </div>
              </div>
            </CardContent>
