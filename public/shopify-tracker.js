...
(function () {
  ...
  function init() {
    ...
    const script =
      ...
      document.querySelector('script[src*="shopify-tracker.js"]');
    if (script) {
  ...
  function attachEventListenersToElement(element) {
    ...
    const addToCartButtons = element.querySelectorAll(
      '[data-action="add-to-cart"], .add-to-cart, [class*="cart"], button[type="submit"]',
    );
