// PriceHunt Simple Tracking (CORS-free solution)
(function() {
  'use strict';
  ...
  const config = {
    ...
    endpoint: 'https://pavlo4.netlify.app/.netlify/functions/track-simple',
    debug: true
  };
  ...
  function sendEvent(eventType, data = {}) {
    ...
    // Send to simple tracking endpoint
  ...
  // Initialize
  function init() {
    log('PriceHunt Simple Tracker initialized');
    trackPageView();
    setupEventListeners();
  }
