    ...
    function initializeTracking() {
        ...
        function setupEnhancedCartTracking() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if ((target.matches('a[href*="/products/"]') || target.closest('a[href*="/products/"]')) && window.PriceHuntTracker) {
            ...
            document.addEventListener('click', function(e) {
                ...
                if ((href.includes('/checkout') || (href.includes('/cart') && target.textContent.toLowerCase().includes('checkout'))) && window.PriceHuntTracker) {
