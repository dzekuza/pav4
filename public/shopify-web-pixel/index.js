// Shopify Web Pixel Extension for ipick.io
// This file contains the web pixel code that will be installed on Shopify stores
...
register(({analytics}) => {
  ...
  function sendTrackingData(eventType, data) {
    ...
    console.log(`[ipick Web Pixel] Sending ${eventType} event:`, trackingData);
    ...
    .catch(error => {
      ...
      try {
        ...
        console.log(`[ipick Web Pixel] Event sent via image beacon`);
      } catch (e) {
        console.error(`[ipick Web Pixel] Image beacon failed:`, e);
      }
    });
  }
  ...
  analytics.subscribe('checkout_address_info_submitted', (event) => {
    console.log('[ipick Web Pixel] Checkout address info submitted:', event);
  ...
  analytics.subscribe('checkout_shipping_info_submitted', (event) => {
    console.log('[ipick Web Pixel] Checkout shipping info submitted:', event);
  ...
  analytics.subscribe('payment_info_submitted', (event) => {
    console.log('[ipick Web Pixel] Payment info submitted:', event);
  ...
  console.log('[ipick Web Pixel] Web pixel registered successfully');
});
