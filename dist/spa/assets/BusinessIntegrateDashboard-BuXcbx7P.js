import{j as e,C as n,B as F,y as B,I as M,J as I,E as R,x as E,A as Y,r as W}from"./vendor_ui-DPKP3YLX.js";import{r as o}from"./vendor_react-Bpl_dUPQ.js";import{B as m}from"./button-DP2dp-PV.js";import{C as f,a as b,b as j,c as v,d as N}from"./card-CUmbL-D9.js";import{L as P}from"./label-Ci8XuWqp.js";import{u as q}from"./index-ZVa9_c7w.js";import{d as V}from"./vendor_router-0FUT4RNd.js";function ee(){const{stats:t}=V(),{toast:c}=q(),[a,k]=o.useState(1),[s,u]=o.useState(null),[x,_]=o.useState(!1),[h,y]=o.useState([]),[A,T]=o.useState(!1);o.useEffect(()=>()=>{window.__ph_pollInterval&&clearInterval(window.__ph_pollInterval),window.__ph_stopTimeout&&clearTimeout(window.__ph_stopTimeout)},[]),o.useEffect(()=>{if(t!=null&&t.domain&&!s){const i=t.domain.toLowerCase();i.includes("shopify")||i.includes("myshopify.com")?u(p.find(r=>r.id==="shopify")||null):i.includes("woocommerce")||i.includes("wordpress")?u(p.find(r=>r.id==="woocommerce")||null):i.includes("magento")&&u(p.find(r=>r.id==="magento")||null)}},[t==null?void 0:t.domain,s]);const p=[{id:"shopify",name:"Shopify",description:"E-commerce platform for online stores",icon:"🛍️",features:["Product tracking","Purchase tracking","Cart tracking","User behavior"],get scriptTemplate(){return`<!-- PriceHunt Shopify Integration -->
