...
(function() {
    ...
    const script = document.currentScript || document.querySelector('script[src*="shopify-tracker-secure.js"]');
    ...
    async function checkDomainVerification() {
        try {
            ...
            if (data.success && data.verified) {
                ...
                console.error('[PriceHunt] Domain not verified. Please verify your domain ownership first.');
