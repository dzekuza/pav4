...
async function checkDatabase() {
  try {
    ...
    console.log(
      `Found ${trackingEvents.length} tracking events (showing first 5):`,
    );
    ...
    console.log(
      `Found ${businessClicks.length} business clicks (showing first 5):`,
    );
    ...
    console.log(
      `Found ${businessConversions.length} business conversions (showing first 5):`,
    );
