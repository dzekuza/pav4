...
export class SalesTrackingService {
    ...
    static async getBusinessSalesStats(businessId: number, startDate?: Date, endDate?: Date) {
        try {
    ...
    static async getUserCommissionStats(userId: number, startDate?: Date, endDate?: Date) {
        try {
    ...
    private static async triggerWebhooks(saleId: number, eventType: string, payload: any) {
        try {
    ...
    private static async sendWebhook(webhook: any, eventType: string, payload: any) {
        try {
