...
async function migrateToNetlifyDB() {
    ...
    try {
        ...
        for (const business of businesses) {
            console.log(`4️⃣ Migrating business: ${business.name} (ID: ${business.id})`);
            ...
            try {
                ...
                if (existingBusiness) {
                    console.log(`   ⚠️  Business ${business.name} already exists in Netlify database`);
                    continue;
                }
                ...
                console.log(`   ✅ Business ${business.name} migrated successfully (New ID: ${newBusiness.id})`);
        ...
        console.log(`✅ Netlify database now has ${netlifyBusinesses.length} businesses`);
...
console.log('============================');
console.log('This script will migrate your business data from the local database');
